...
Use the main.txt file to scrap the information form the website using ChatGPT. 
Change the link in the main.txt file with the website's link you want to scrap from. 
